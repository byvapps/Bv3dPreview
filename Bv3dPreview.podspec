...
Pod::Spec.new do |s|
  s.name             = 'Bv3dPreview'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Bv3dPreview.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/koldo92/Bv3dPreview'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'koldo92' => 'koldo@byvapps.com' }
  s.source           = { :git => 'https://github.com/koldo92/Bv3dPreview.git', :tag => s.version.to_s }
